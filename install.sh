...
conda install -n openpoints -y pytorch=1.10.1 torchvision cudatoolkit=11.0 -c pytorch -c nvidia

# # install relevant packages
# # torch-scatter is a must, and others are optional
python -m pip install torch-scatter -f https://data.pyg.org/whl/torch-1.10.1+cu113.html
